...
topics:
  - name: "communication"
    ...
    content:
      ...
      - level: 5
        criteria:
          - "Gives external talks on role of EAs at Upp, and how this creates value and contributes to Upp's overall success."
  - name: "impact"
    title:
    content:
      - level: 2
      ...
      - level: 5
        criteria:
          ...
          - "Owns projects that impact Upp as a whole, leveraging stakeholders to deliver results."
  - name: "knowledge"
    title:
    content:
      - level: 1
        exampleCriteria:
          - criteria: "Learning how to use all Upp's internal tools"
            examples:
              - "GSuite"
              - "Slack"
              - "Lattice"
      ...
      - level: 5
        criteria:
          - "Strong understanding of all executives responsibilities at Upp, with ability to adapt to support any executive to high standard at short notice."
  - name: "teamwork"
    title:
    content:
      - level: 3
